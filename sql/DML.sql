...
INSERT INTO `php-prj`.`payments` (from_acc, to_acc, payment_time, amount, description, status) VALUES ('1155744622468832', '1234534859203456', now(), 6000, 'description_5', 1);
INSERT INTO `php-prj`.`payments` (from_acc, to_acc, payment_time, amount, description, status) VALUES ('1155744622468832', '9784543829216754', now(), 7000, 'description_6', 1);